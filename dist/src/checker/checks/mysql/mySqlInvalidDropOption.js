...
exports.MySqlInvalidDropOption = void 0;
const statements_1 = require("../../../barrel/statements");
const invalidOption_1 = require("../invalidOption");
class MySqlInvalidDropOption extends invalidOption_1.InvalidOption {
    constructor() {
        super(...arguments);
...
exports.MySqlInvalidDropOption = MySqlInvalidDropOption;
//# sourceMappingURL=mySqlInvalidDropOption.js.map