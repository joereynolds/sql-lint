...
const missingWhere_1 = require("./checker/delete/missingWhere");
const oddCodePoint_1 = require("./checker/generic/oddCodePoint");
const databaseNotFound_1 = require("./checker/use/databaseNotFound");
