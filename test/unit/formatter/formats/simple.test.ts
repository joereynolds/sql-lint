...
test.each([
  [
      "test", 
      new CheckerResult(1, "some content"), "test:1 some content",
      0
  ],
  [
      "test-extra", 
      new CheckerResult(1, "some content", "more"), "test-extra:1 some content",
      0
  ],
  [
      "test-again", 
      new CheckerResult(1, "some content", "more"), "test-again:1 some content more",
      1
  ]
])(
