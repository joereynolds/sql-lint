...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "name", "symbols": ["name$ebnf$1"], "postprocess": (word) => word[0].join("") },
        ...
        { "name": "trigger$subexpression$1", "symbols": [/[tT]/, /[rR]/, /[iI]/, /[gG]/, /[gG]/, /[eE]/, /[rR]/], "postprocess": function (d) { return d.join(""); } },
        ...
        { "name": "drop_trigger", "symbols": ["keyword", "trigger", "clause_if_exists", "name"], "postprocess": function (statement) {
                return {
        ...
        { "name": "drop_logfile_group", "symbols": ["keyword", "logfile", "group", "name", "__", "engine", "optional_equals", "_", "name"], "postprocess": function (statement) {
                return {
                    statement_type: statement[0],
                    logfile: statement[3],
                    engine: statement[8]
        ...
        { "name": "engine$subexpression$1", "symbols": [/[eE]/, /[nN]/, /[gG]/, /[iI]/, /[nN]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
        { "name": "engine", "symbols": ["engine$subexpression$1", "__"] },
        { "name": "logfile$subexpression$1", "symbols": [/[lL]/, /[oO]/, /[gG]/, /[fF]/, /[iI]/, /[lL]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
        { "name": "logfile", "symbols": ["logfile$subexpression$1", "__"] },
        { "name": "group$subexpression$1", "symbols": [/[gG]/, /[rR]/, /[oO]/, /[uU]/, /[pP]/], "postprocess": function (d) { return d.join(""); } },
        ...
        { "name": "procedure$subexpression$1", "symbols": [/[pP]/, /[rR]/, /[oO]/, /[cC]/, /[eE]/, /[dD]/, /[uU]/, /[rR]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
        { "name": "procedure", "symbols": ["procedure$subexpression$1", "__"], "postprocess": (word) => word.join("") },
