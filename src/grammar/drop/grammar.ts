...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "drop_trigger", "symbols": ["keyword", "trigger", "clause_if_exists", "name"], "postprocess": 
        function(statement) {
            return {
    ...
    {"name": "drop_logfile_group", "symbols": ["keyword", "logfile", "group", "name", "__", "engine", "optional_equals", "_", "name"], "postprocess": 
        function(statement) {
            return {
                statement_type: statement[0],
                logfile: statement[3],
