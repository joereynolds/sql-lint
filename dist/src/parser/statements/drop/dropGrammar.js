...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id },
        { "name": "drop_statement", "symbols": ["keyword", "_", "option", "_", "everything_else", "_", "terminator"], "postprocess": function (data) {
                return {
                    keyword: data[0],
                    option: data[2],
                };
    ...
    ParserStart: "drop_statement",
};
exports.default = grammar;
//# sourceMappingURL=dropGrammar.js.map